...
export function SummaryBar({ summary }) {
  ...
  const stats = [
    ...
    { label: "🔥 Strong Sell", value: summary.strong_sell_count, sub: "sets ready to flip", color: "text-green-400" },
    { label: "👀 Consider", value: summary.consider_count, sub: "sets worth watching", color: "text-yellow-400" },
    { label: "💤 Hold", value: summary.hold_count, sub: "sets to keep", color: "text-slate-400" },
  ];
